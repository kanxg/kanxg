...
<%
   boolean firstload=false;
	...
	if(!firstload ){
		matchprolist=hollisterco.getwomendiscountproductforJsp(showdiscount,email,searchtext);
	};
...
<html lang="en">
  ...
  <body>
   ...
   <g:render template="top" /> 
    ...
    <form name="frm" action="<%=request.getContextPath()%>/hco/searchhcowomen" method="post" onsubmit="return checkinput()">
      <table>
      <tr>
