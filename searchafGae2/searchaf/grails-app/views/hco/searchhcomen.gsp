...
<%
	...
	if(!firstload ){
		matchprolist=hollisterco.getmendiscountproductforJsp(showdiscount,email,searchtext);
	};
...
<html lang="en">
  ...
  <body>
   ...
   <g:render template="top" /> 
     ...
     <form name="frm" class="form-horizontal" action="<%=request.getContextPath()%>/hco/searchhcomen" method="post" onsubmit="return checkinput()">
      <table>
      <tr>
