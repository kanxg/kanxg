...
<html lang="en">
 ...
 <form id="form1" class="form-horizontal">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" name="url" id="url" style="width: 100%" value="http://www.gnc.com/Panasonic-ES-LV61-A-Electric-Multiflex-Pivoting/dp/B005GNL5G4/ref=lh_ni_t?ie=UTF8&psc=1&smid=ATVPDKIKX0DER">
      	<p class="text-info">*  必须是Gnc网站的产品，打开你的产品页面，拷贝URL到这里 </p>
    </div>
  </div>
