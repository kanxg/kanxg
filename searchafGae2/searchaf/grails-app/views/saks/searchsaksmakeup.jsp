...
<%@ page import="kxg.searchaf.url.saks_cat.SearchSaksJSP" %>
<%@ page import="kxg.searchaf.url.saks_cat.SaksProduct" %>
<%@ page import="kxg.searchaf.url.saks_cat.SaksConstant" %>
...
%>
    ...
    <form name="frm" action="<%=request.getContextPath()%>/saks/searchsaksmakeup" method="post" onsubmit="return checkinput()">
      <table>
      <tr>
