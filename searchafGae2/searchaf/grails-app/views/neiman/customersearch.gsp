...
%>
    ...
    <form name="frm" action="<%=request.getContextPath()%>/neiman/customersearch" method="post" onsubmit="return checkinput()">
      <table>
             <tr>
      		<td>搜索URL:<input type="text" name="searchurl" value="<%=searchurl%>" size="160"/></td>
      		<td>输入Neiman 网站任意链接</td>
      </tr>
	 ...
	 <tr>
      		...
      		<td><input type="submit" value="返回" onclick="back();"/></td>
      </tr>
      </table>
     </form>
