...
<%@ page import="kxg.searchaf.url.neiman_cat.SearchNeimanJSP" %>
<%@ page import="kxg.searchaf.url.neiman_cat.NeimanProduct" %>
<%@ page import="kxg.searchaf.url.neiman_cat.NeimanConstant" %>
...
%>
    ...
    <form name="frm" action="<%=request.getContextPath()%>/neiman/searchneimanmakeup" method="post" onsubmit="return checkinput()">
      <table>
      <tr>
...
function back(){
	document.frm.action="neiman.html";
	document.frm.submit();
}
