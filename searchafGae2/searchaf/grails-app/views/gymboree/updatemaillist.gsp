...
<html lang="en">
 ...
 <form id="form1" class="form-horizontal" action="<%=request.getContextPath()%>/gymboree/updatemaillist" method="post">
  <div class="control-group">
   ...
   <div class="control-group">
    <label class="control-label" for="warningMen">男小童</label>
    <div class="controls">
  ...
  <div class="control-group">
    <label class="control-label" for="mencheckingSaleDiscount">男小童告警折扣</label>
    <div class="controls">
    ...
    <div class="control-group">
    <label class="control-label" for="warningWomen">女小童</label>
    <div class="controls">
	          <div class="make-switch" data-on-label="是" data-off-label="否" tabindex="0">
  ...
  <div class="control-group">
    <label class="control-label" for="womencheckingSaleDiscount">女小童告警折扣</label>
    <div class="controls">
...
$( document ).ready(function(){
  ...
   $("#loadbutton").click(function() {
  	  $("#form1").attr("action", "<%=request.getContextPath()%>/gymboree/updatemaillist?action=load");
   });
  
   $("#updatebutton").click(function() {
  	var tem1=$("#mencheckingSaleDiscount").val();
  	if(!isNumber(tem1)){
		$.globalMessenger().post("男小童折扣，请输入0至1之间的一个数值");
		return false;
	}
	...
	var tem2=$("#womencheckingSaleDiscount").val();
  	if(!isNumber(tem2)){
		$.globalMessenger().post("女小童折扣，请输入0至1之间的一个数值");
		return false;
	}
	...
	if(Number(tem4)<0.01 || Number(tem2)>1){
		...
		return false;
   		...
   		$("#form1").attr("action", "<%=request.getContextPath()%>/gymboree/updatemaillist?action=update");
   });
