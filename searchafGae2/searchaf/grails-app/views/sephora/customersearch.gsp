...
<%@ page import="kxg.searchaf.url.sephora.SearchSephoraJSP" %>
<%@ page import="kxg.searchaf.url.sephora.SephoraProduct" %>
<%@ page import="kxg.searchaf.url.sephora.SephoraConstant" %>
...
%>
    ...
    <form name="frm" action="<%=request.getContextPath()%>/sephora/customersearch" method="post" onsubmit="return checkinput()">
      <table>
             <tr>
      		<td>搜索URL:<input type="text" name="searchurl" value="<%=searchurl%>" size="160"/></td>
      		<td>输入Sephora网站任意链接</td>
      </tr>
