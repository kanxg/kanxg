...
<div class="container">
       <div class="hero-unit">
				 ...
				 <form id="form1" class="form-horizontal" action="<%=request.getContextPath()%>/jcrew/addmaillist" method="post">
...
$( document ).ready(function(){
  ...
   $("#addbutton").click(function() {
   		$("#form1").attr("action", "<%=request.getContextPath()%>/jcrew/addmaillist?action=add");
   });
   
    $("#updatebutton").click(function() {
   		$("#form1").attr("action", "<%=request.getContextPath()%>/jcrew/updatemaillist?action=add");
   });
