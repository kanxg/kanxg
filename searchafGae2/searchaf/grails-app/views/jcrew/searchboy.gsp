...
<%@ page import="kxg.searchaf.url.jcrew.SearchJcrewJSP" %>
<%@ page import="kxg.searchaf.url.jcrew.JcrewProduct" %>
<%@ page import="kxg.searchaf.url.jcrew.JcrewConstant" %>
...
%>
    ...
    <form name="frm" action="<%=request.getContextPath()%>/jcrew/searchboy" method="post" onsubmit="return checkinput()">
      <table>
      <tr>
...
function back(){
	document.frm.action="jcrew.html";
	document.frm.submit();
}
