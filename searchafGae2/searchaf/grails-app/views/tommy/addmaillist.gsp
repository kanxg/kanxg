...
<div class="container">
       <div class="hero-unit">
				 ...
				 <form id="form1" class="form-horizontal" action="<%=request.getContextPath()%>/tommy/addmaillist" method="post">
...
$( document ).ready(function(){
  ...
   $("#addbutton").click(function() {
   		$("#form1").attr("action", "<%=request.getContextPath()%>/tommy/addmaillist?action=add");
   });
   
    $("#updatebutton").click(function() {
   		$("#form1").attr("action", "<%=request.getContextPath()%>/tommy/updatemaillist?action=add");
   });
