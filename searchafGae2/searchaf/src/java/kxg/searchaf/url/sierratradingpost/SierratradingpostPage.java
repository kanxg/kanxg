...
public class SierratradingpostPage {
	...
	public SierratradingpostPage() {
	}

	public SierratradingpostPage(String url, String mailaddress) {
	...
	public String parseHTML() {
		...
		html = html
				+ "<a href='http://www.ebuybot.com/jsp/sierratradingpost/addmaillist.jsp'>"
				+ "不想再接到这个提醒了！" + "</a>";
		return html;
	}
	...
	public String toString() {
		return "SierratradingpostPage [  expectPirce=" + expectPirce + ", price="
				+ price + ", title=" + title + ", mailaddress=" + mailaddress
				+ ", tagcontext=" + tagcontext + ", instock=" + instock + "]";
	}

	public static void main(String[] args) throws Exception {
		String url = "http://www.sierratradingpost.com/dp/B000HZEQSU/ref=as_li_ss_til?tag=helmut-20";
