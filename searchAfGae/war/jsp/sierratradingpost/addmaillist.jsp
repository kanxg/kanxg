...
$( document ).ready(function(){
  ...
   $("#addbutton").click(function() {
   ...
   $("#table1").append("<tr><td><%=apage.prodname%></td><td><a target='_blank' href='<%=apage.getJspUrl()%>'><%=apage.url%><a></td><td><%=apage.expectPirce%></td><td><button type='submit' id='querybutton<%=i%>' class='btn'>Url测试</button><button type='submit' id='deletebutton<%=i%>' class='btn'>删除</button></td></tr>");
