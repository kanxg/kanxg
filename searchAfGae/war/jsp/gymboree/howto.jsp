...
<html lang="en">
 ...
 <form id="form1" class="form-horizontal" >
  <div class="control-group">
   ...
   <div class="control-group">
    <label class="control-label" for="warningWomen">男小童</label>
    <div class="controls">
	  <input type="checkbox" id="warningWomen" name="warningWomen" value="warningWomen" readonly="true">
	     <p class="text-info">* 不勾选将不接收提醒邮件</p>
    </div>
  </div> 
  

  <div class="control-group">
    <label class="control-label" for="womencheckingSaleDiscount">男小童告警折扣</label>
    <div class="controls">
  ...
  <div class="control-group">
   ...
   <div class="control-group">
    <label class="control-label" for="warningWomen">男童装</label>
    <div class="controls">
	  <input type="checkbox" id="warningWomen" name="warningWomen" value="warningWomen" readonly="true">
	     <p class="text-info">* 不勾选将不接收提醒邮件</p>
    </div>
  ...
  <div class="control-group">
    <label class="control-label" for="womencheckingSaleDiscount">男童装告警折扣</label>
    <div class="controls">
      <input type="text" id="womencheckingSaleDiscount" name="womencheckingSaleDiscount"  value="0.4" readonly="true">
      	     <p class="text-info">* 低于当前折扣的产品才会发邮件</p>
    </div>
   ...
   <div class="control-group">
    <label class="control-label" for="warningWomen">女童装</label>
    <div class="controls">
	  <input type="checkbox" id="warningWomen" name="warningWomen" value="warningWomen" readonly="true">
	     <p class="text-info">* 不勾选将不接收提醒邮件</p>
    </div>
  ...
  <div class="control-group">
    <label class="control-label" for="womencheckingSaleDiscount">女童装告警折扣</label>
    <div class="controls">
      <input type="text" id="womencheckingSaleDiscount" name="womencheckingSaleDiscount"  value="0.4" readonly="true">
      	     <p class="text-info">* 低于当前折扣的产品才会发邮件</p>
    </div>
