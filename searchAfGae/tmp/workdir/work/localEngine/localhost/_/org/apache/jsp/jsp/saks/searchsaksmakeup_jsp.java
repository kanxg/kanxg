package org.apache.jsp.jsp.saks;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;
import java.util.*;
import kxg.searchaf.url.saks_cat.SearchSaksJSP;
import kxg.searchaf.url.saks_cat.SaksProduct;
import kxg.searchaf.url.saks_cat.SaksConstant;

public final class searchsaksmakeup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int num = 0;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(showdiscount==null){
		showdiscount=String.valueOf(SaksConstant.warningdiscount);
		firstload=true;
	}
	...
	List<SaksProduct> matchprolist = null;
	if(!firstload ){
		matchprolist=af.getmakeupdiscountproductforJsp(showdiscount,email,searchtext);
	};
 

      out.write("\r\n");
      out.write("\r\n");
      out.write("    <form name=\"frm\" action=\"searchsaksmakeup.jsp\" method=\"post\" onsubmit=\"return checkinput()\">\r\n");
      out.write("      <table>\r\n");
      out.write("      <tr>\r\n");
     ...
     if(matchprolist!=null){
      for (int i = 0; i < matchprolist.size(); i++) {
    	  SaksProduct product= matchprolist.get(i);
    	  int mod=i % 4 ;
     	  if(mod==0){
  ...
  String showcount=request.getParameter("showcount");        
      ...
      out.write("\tdocument.frm.action=\"saks.html\";\r\n");
