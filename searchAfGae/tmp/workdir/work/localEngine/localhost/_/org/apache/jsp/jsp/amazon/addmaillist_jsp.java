...
import java.util.*;
import kxg.searchaf.url.amazon.AmazonPageJSP;
...
request.setCharacterEncoding("utf-8");
	 ...
	 if(url==null){
      ...
      out.write("\t                  <th style=\"width: 10%\">只看自营</th>\r\n");
     ...
     for(int i=0;i<pagelist.size();i++){
      ...
      out.write("</td><td>");
      out.print(apage.checksalerisAmazon);
      ...
      out.print(i);
      out.write("' class='btn'>Url测试</button><button type='submit' id='deletebutton");
      out.print(i);
      ...
      out.print(apage.url);
      out.write("\");\r\n");
      out.write("   \t\t$(\"#checksalerisAmazon\").attr(\"checked\", ");
      out.print(apage.checksalerisAmazon);
      out.write(");\r\n");
