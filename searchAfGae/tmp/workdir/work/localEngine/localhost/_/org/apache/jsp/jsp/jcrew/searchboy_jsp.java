...
import java.util.*;
import kxg.searchaf.url.jcrew.SearchJcrewJSP;
import kxg.searchaf.url.jcrew.JcrewProduct;
import kxg.searchaf.url.jcrew.JcrewConstant;

public final class searchboy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int num = 0;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(showdiscount==null){
		showdiscount=String.valueOf(JcrewConstant.warningdiscount);
		firstload=true;
	}
	...
	List<JcrewProduct> matchprolist = null;
	if(!firstload ){
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("    <form name=\"frm\" action=\"searchboy.jsp\" method=\"post\" onsubmit=\"return checkinput()\">\r\n");
      out.write("      <table>\r\n");
      out.write("      <tr>\r\n");
     ...
     if(matchprolist!=null){
      for (int i = 0; i < matchprolist.size(); i++) {
    	  JcrewProduct product= matchprolist.get(i);
    	  int mod=i % 4 ;
     	  if(mod==0){
  ...
  String showcount=request.getParameter("showcount");        
      ...
      out.write("\tdocument.frm.action=\"jcrew.html\";\r\n");
