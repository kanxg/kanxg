package org.apache.jsp.jsp.gymboree;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;
import java.util.*;
import kxg.searchaf.url.gymboree.SearchGymboreeJSP;
import kxg.searchaf.url.gymboree.GymboreeProduct;
import kxg.searchaf.url.gymboree.GymboreeConstant;

public final class searchgymboreebabygirl_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int num = 0;
 ...
 boolean firstload=false;
    ...
    if(showdiscount==null){
		showdiscount=String.valueOf(GymboreeConstant.warningdiscount);
		firstload=true;
	}
	...
	List<GymboreeProduct> matchprolist = null;
	if(!firstload ){
		matchprolist=af.getbabygirldiscountproductforJsp(showdiscount,email,searchtext);
	};
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("    <form name=\"frm\" action=\"searchgymboreebabygirl.jsp\" method=\"post\" onsubmit=\"return checkinput()\">\r\n");
      out.write("      <table>\r\n");
      out.write("      <tr>\r\n");
     ...
     if(matchprolist!=null){
      for (int i = 0; i < matchprolist.size(); i++) {
    	  GymboreeProduct product= matchprolist.get(i);
    	  int mod=i % 4 ;
     	  if(mod==0){
  ...
  String showcount=request.getParameter("showcount");        
      ...
      out.write("\tdocument.frm.action=\"gymboree.html\";\r\n");
