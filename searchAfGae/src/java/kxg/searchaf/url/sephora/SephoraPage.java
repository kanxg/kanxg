...
public class SephoraPage {
	...
	public SephoraPage(String url, String mailaddress) {
	...
	public String parseHTML() {
		...
		html = html
				+ "<a href='http://www.ebuybot.com/jsp/sephora/addmaillist.jsp'>"
				+ "不想再接到这个提醒了！" + "</a>";
		return html;
	}
	...
	public String toString() {
		return "SephoraPage [  expectPirce=" + expectPirce + ", price="
