...
public class AmazonPageJSP {
	...
	public String addNewMail(String mailaddress, String prodname, String url,
		...
		// System.out.println("checksalerisAmazon:" + checksalerisAmazon);
		String returnkey = "";
		if (!isAmazonUrl(url)) {
			return "notamazon";
		}
	...
	public static void main(String[] args) throws Exception {
		...
		List<AmazonPage> pagelist = jsp.loadMail("xingang.af1@gmail.com");
		...
		if (pagelist != null) {
			for (int i = 0; i < pagelist.size(); i++) {
				...
				System.out.println(apage.prodname);
			}
		}

		// AmazonPage page = jsp
		// .testUrl(
		// "http://www.amazon.com/New-Balance-KV990-Hook-Loop/dp/B005Q5UPZY/ref=sr_1_2?s=shoes&ie=UTF8&qid=1382147309&sr=1-2&keywords=New+Balance+KV990",
		// true);
