...
import kxg.searchaf.url.amazon.ParserAmazonUkPage;
...
public class ParserAmazonUkPage {
	public AmazonPage page;

	public ParserAmazonUkPage(AmazonPage page) {
		this.page = page;
	};
...
//		System.out.println("checking amazon url:" + page.getUrl());
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (tag instanceof TitleTag) {
				...
				page.title = d.getTitle().replaceAll("Amazon.co.uk:", "").trim();
				...
				if (p instanceof Div) {
					...
					if (sStr.indexOf("Dispatched from and sold by <b>Amazon</b>") > 0) {
	...
	public static void main(String[] args) throws Exception {
		...
		amazonPage.url = "http://www.amazon.co.uk/FINEST-PROFESSIONAL-BOTTLE-EDIBLE-SUGARCRAFT/dp/B007Q13JJA/ref=zg_bs_grocery_4";
		ParserAmazonUkPage ParserAmazonUkPage = new ParserAmazonUkPage(amazonPage);
		ParserAmazonUkPage.checkprice();
