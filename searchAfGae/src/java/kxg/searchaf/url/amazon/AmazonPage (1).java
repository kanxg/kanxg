...
public class AmazonPage {
	...
	public String parseHTML() {
		...
		html = html + "<a href='http://www.ebuybot.com/jsp/amazon/addmaillist.jsp'>" + "不想再接到这个提醒了！"
				+ "</a>";
		return html;
	}
	...
	public String toString() {
		return "AmazonPage [  expectPirce=" + expectPirce + ", price=" + price
				+ ", title=" + title + ", mailaddress=" + mailaddress
				+ ", tagcontext=" + tagcontext + ", salerisAmazon="
				+ salerisAmazon + ", instock=" + instock + "]";
	}
