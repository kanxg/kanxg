...
public class ParserTommyPage {
	public TommyPage page;
	public HashMap<Integer, TommyProduct> allprolist;
	public TommyProduct product;

	public ParserTommyPage(TommyPage page,
			HashMap<Integer, TommyProduct> allprolist) {
		this.page = page;
	...
	public void checkprice() throws Exception {
		...
		// System.out.println("checking Tommy url [" + page.url + "]");
