...
import kxg.searchaf.url.drugstore.ParserDrugstorePage;
import kxg.searchaf.url.drugstore.DrugstorePage;
...
public class ParserDrugstorePage {
	public DrugstorePage page;

	public ParserDrugstorePage(DrugstorePage page) {
		this.page = page;
	};
	...
	public void checkprice() throws Exception {
		...
		NodeFilter name_filter3 = new AndFilter(new NodeClassFilter(Div.class),
				new HasAttributeFilter("id", "divAvailablity"));
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (tag instanceof TitleTag) {
				...
				page.title = d.getTitle().replaceAll("| drugstore.com", "")
						.trim();
	...
	public static void main(String[] args) throws Exception {
		...
		drugstorePage.url = "http://www.drugstore.com/cottonelle-fresh-care-flushable-moist-wipes-tub/qxp157237?catid=180658";
