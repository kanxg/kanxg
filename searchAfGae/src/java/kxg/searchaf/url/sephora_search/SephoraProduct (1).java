...
public class SephoraProduct implements Comparable<Object> {
	...
	public void buildTagContext() {
		this.tagcontext = "<a href=\"" + SephoraConstant.websiteurl + this.url
				+ "\"><img  src=\"" + SephoraConstant.websiteurl + this.img_src
				+ "\"></a>";
	}
	...
	public int compareTo(Object o) {
		SephoraProduct comp = (SephoraProduct) o;
